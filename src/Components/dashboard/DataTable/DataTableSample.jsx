...
const items = [
  { label: "Components" },
  {
    ...
    template: () => (
      <Link to='/dataTables'>
        <a className="text_color font-semibold">Data Table</a>
      </Link>
    ),
  }
];
...
const DataTableSample = () => {
  ...
  const renderHeader = () => {
    return (
      <div className="flex flex-col lg:flex-row lg:justify-between items-center p-1 top_header_bg ">
        <div className="flex gap-2 order-2 lg:order-1 mt-2 lg:mt-0">
          <div className="rounded-sm text-xl bg-blue-600 text_color_dark px-4 py-[8px] font-medium hover:bg-blue-700 duration-500">
          ...
          <FilterDropdown />
          <div className="rounded-sm text-lg hover:cursor-pointer bg-blue-600 text_color_dark px-4 font-medium hover:bg-blue-700 duration-500 flex items-center">
            <Button
              className="text-2xl my-[6px]"
              type="button"
              icon={FaPrint}
              severity="warning"
              onClick={exportPdf}
        ...
        <div className="relative w-full lg:w-1/2 order-1 lg:order-2">
          ...
          <InputText
            className="text-lg font-normal border border-green-600 rounded-sm bg-white p-2 w-full"
        ...
        <div className="lg:flex items-center gap-2 hidden lg:order-3">
          <FilterDropdown />
          <div className="rounded-sm text-lg hover:cursor-pointer bg-blue-600 text_color_dark px-4 font-medium hover:bg-blue-700 duration-500 flex items-center">
            <Button
              className="text-2xl my-[6px]"
